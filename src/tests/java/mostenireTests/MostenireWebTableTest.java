...
//completam campul first name in tab./1. ident. buton/2. specifica valoare /3. scrie valoare in tab
       ...
       By lastNameElement= By.id("lastName"));
        ...
        elementHelper.fillLocator(lastNameElement, firstNameValue);
...
//        editFirstNameElement.sendKeys(editFirstNameValue);
        elementHelper.fillLocator(editElement, editFirstNameValue);
...
//        clearEditFirstNameElement.sendKeys(clearEditFirstNameValue);
        elementHelper.fillLocator(clearEditFirstNameElement, clearEditFirstNameValue);
...
//        clearEditlastNameElement.sendKeys(clearEditLastNameValue);
        elementHelper.fillLocator(clearEditlastNameElement, clearEditLastNameValue);
...
//        clearEditUserElement.sendKeys(clearEditUserValue);
        elementHelper.fillLocator(clearEditUserElement, clearEditUserValue);
...
//        clearEditSalaryElement.sendKeys(clearEditSalaryValue);
        elementHelper.fillLocator(clearEditSalaryElement, clearEditSalaryValue);
...
//        clearEditDepartmentElement.sendKeys(clearEditDepartmentValue);
        elementHelper.fillLocator(clearEditDepartmentElement, clearEditDepartmentValue);
